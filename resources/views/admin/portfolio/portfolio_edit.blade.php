                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.portfolio',$portfolio->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{$portfolio->portfolio_name}}" name="portfolio_name" id="name">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text"  value="{{$portfolio->portfolio_title}}" name="portfolio_title" id="name">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" class="form-control" name="portfolio_description">{{$portfolio->portfolio_description}}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="show_image" class="rounded-circle avatar-lg"
                                            src="{{ asset($portfolio->portfolio_image) }}" alt="profile image">
                                    </div>
                                </div>
                                <input type="submit" class="btn btn-info wave-effect waves-light" value="Portfolio Update">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
