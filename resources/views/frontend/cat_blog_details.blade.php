                    ...
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ $categoryName->blog_category }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    @foreach ($blogpost as $item)
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <a href="{{ route('details.blog', $item->id) }}"><img src="{{ asset($item->blog_image) }}"
                                        alt=""></a>
                                <a href="{{ route('details.blog', $item->id) }}" class="blog__link"><i
                            ...
                            <div class="standard__blog__content">
                                ...
                                <h2 class="title"><a
                                        href="{{ route('details.blog', $item->id) }}">{{ $item->blog_title }}</a></h2>
                            ...
                            <ul class="sidebar__cat">
                                @foreach ($categoris as $item)
                                    <li class="sidebar__cat__item"><a
                                            href="{{ route('category.post', $item->id) }}">{{ $item->blog_category }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
